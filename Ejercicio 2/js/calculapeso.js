...
var planeta = parseInt(prompt("Elije el planeta con el que quieras saber tu peso:\n1. = Mercurio. \n2. = Venus. \n3. = Marte. \n4. = Jupiter. \n5. = Saturno. \n6. = Urano. \n7. = Neptuno. "));
...
if(planeta == 1){
  ...
  n_planeta = "Mercurio";
  //Error Nan: Significa not a number. javascript no ssabe q está tratando de hacer
}else if(planeta == 2){
